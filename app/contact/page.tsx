...
// ─── Theme tokens (same as dashboard) ────────────────────────────────────────
const C = {
  bg:         "#07080C",
...
const CONTACT_EMAIL = "hello@inflyio.com";
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setStatus("sending");
    try {
      // Opens native mail client — swap this for Resend / Formspree later
      const body = encodeURIComponent(
        `Name: ${form.name}\nEmail: ${form.email}\n\n${form.message}`
      );
      const mailtoLink = `mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent(form.subject || "Inflyio Enquiry")}&body=${body}`;
      ...
      <div style={{
        ...
        <div className="f1" style={{ marginBottom: "36px" }}>
          ...
          <p style={{
            ...
            marginTop: "8px", maxWidth: "480px", lineHeight: 1.8,
          }}>
            Have a question, partnership idea, or feedback about Inflyio?
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: "24px", alignItems: "start" }}>
          ...
          <div className="f2" style={{
            ...
            {status === "sent" ? (
              ...
              <div style={{
                ...
                padding: "40px 20px", gap: "14px", textAlign: "center",
              }}>
                <div style={{
                ...
                <div>
                  <div style={{
                    ...
                    fontSize: "16px", color: C.textPri, marginBottom: "6px",
                  }}>
                    Message sent!
                  </div>
                  <div style={{ fontSize: "12px", color: C.textSec, lineHeight: 1.7 }}>
                    Your mail client should have opened.<br />
                    We'll get back to you at <span style={{ color: C.blue }}>{form.email || "your email"}</span>.
                  </div>
                </div>
                <button
          ...
          <div className="f3" style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "10px", color: C.blue, letterSpacing: ".1em", textTransform: "uppercase", marginBottom: "10px" }}>
                Email Us
              </div>
              <a
              ...
              <div style={{ fontSize: "11px", color: C.textSec, lineHeight: 1.6 }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "10px", color: C.textSec, letterSpacing: ".1em", textTransform: "uppercase", marginBottom: "14px" }}>
                What to Expect
              </div>
              {[
            ...
            <div style={{
              ...
              <span style={{ color: C.textMid, fontFamily: "'Syne',sans-serif", fontWeight: 600 }}>
                inflyio
              </span>{" "}
